...
- **Header Action Toolbar**: Configuration actions (**Import JSON**, **Export JSON**, and **Reset to TXT**) are placed directly in the modal header bar alongside the `[ESC] CLOSE` button, matching the layout pattern of the History Viewer Modal for seamless accessibility.
